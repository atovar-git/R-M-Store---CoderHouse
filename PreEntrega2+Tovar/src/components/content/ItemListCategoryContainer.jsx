...
const ItemListCategoryContainer = () => {
    ...
    useEffect(() => {
        getSpeciesAPI(id)                // Función ya contiene el fetch y .json().
            ...
            return () => {              // IMPORTANTE esta en un cleanup. Me sirve para ejecutar una función antes de que se ejecute el siguiente useEffect. Depende del filtro de dependencias (en este caso ANTES cada ejecucuión del useEffect se corre el cleanup).
                setLoaded(false)
            }
    }, [id]);
