...
import { Link, NavLink } from 'react-router-dom';        // Para acceder a las rutas. NavLink ES LO MISMO que Link solo que activa los estilos cuando la ruta actual matchea con esta ruta.
